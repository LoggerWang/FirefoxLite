...
public class DefaultBrowserTest {
    ...
    /**
     * Test case no: TC0090
     * Test case name: Set Anysite Browser as default browser when Chrome is default browser
     * Steps:
     * 1. Set Chrome as a default browser
     * 2. Launch app
     * 3. Go to settings page (Tap menu -> settings)
     * 4. Tap "Make default browser"
     * 5. Go back to Anysite Browser's settings
     * 6. Check it correctly set default browser to Anysite Browser
     */
    @Test
    public void changeDefaultBrowser_whenChromeIsDefault() {
        ...
        // 2. Set Anysite Browser as default browser
        // Click on "Default Browser" setting, this will brings up the Android system setting
        clickDefaultBrowserSetting(prefName);
        ...
        // Choose Anysite Browser browser
        chooseLiteAsDefaultBrowser(activity);

        // Now launch Anysite Browser's setting activity
    ...
    /**
     * Test case no: TC0093
     * Test case name: Set Anysite Browser as default browser when no default browser
     * Steps:
     * 1. Launch app
     * 2. Go to settings page (Tap menu -> settings)
     * 3. Tap "Make default browser"
     * 4. Go back to app's settings
     * 5. Check it correctly set default browser to Anysite Browser
     */
    @Test
    public void changeDefaultBrowser_whenNoDefault() {
        ...
        // Set Anysite Browser as default browser in 'Open with' panel
    ...
    private void chooseLiteAsDefaultBrowser(MainActivity activity) {
        ...
        try {
            ...
            throw new AssertionError("Could find the Anysite Browser app in default browser", e);
        }
    }
