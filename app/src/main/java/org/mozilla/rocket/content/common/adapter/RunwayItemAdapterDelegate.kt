...
class RunwayItemViewHolder(
    ...
    var runway_card: CardView?=containerView.findViewById(R.id.runway_card)
    var runway_source: TextView?=containerView.findViewById(R.id.runway_source)
    var runway_image: ImageView?= containerView.findViewById(R.id.runway_image)
    init {
//        runway_card = containerView.findViewById(R.id.runway_card)
//        runway_source = containerView.findViewById(R.id.runway_source)
//        runway_image = containerView.findViewById(R.id.runway_image)
