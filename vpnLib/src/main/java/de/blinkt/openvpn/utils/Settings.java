...
public class Settings {
    ...
    private static final String DEFAULT_NAME = "max_file_sp";
    ...
    public Settings(@NonNull Context context, @NonNull String name) {
        ...
        if (spPair == null) {
            Log.e(TAG, name + "'s SharedPreferences is null!");
            return;
        }
    ...
    public boolean getBoolean(@NonNull String key, boolean defVal) {
        ...
        if (value != null) {
            try {
                ...
                Log.e(TAG, "getBoolean e = " + e.toString());
            }
        }
        return defVal;
    }
    ...
    private static final HashMap<String, WeakReference<Pair<SharedPreferences, SharedPreferences.Editor>>> mSPHashMap = new HashMap<>();

    private static synchronized Pair<SharedPreferences, SharedPreferences.Editor> getSettings(Context context,
                                                                                              String name) {
        if (context == null)
            return null;
